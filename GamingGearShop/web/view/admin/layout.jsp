<%-- 
    Document   : layout
    Created on : Mar 18, 2026, 11:39:05 PM
    Author     : ACER
--%>
...
<html lang="vi">
    <head>
        ...
        <title>${pageTitle} - Admin Gaming Gear Shop</title>
    ...
    <body>
        ...
        <%-- THÔNG BÁO TOAST — đọc msg từ URL --%>
        ...
        <div class="main-wrapper">
            ...
            <%-- NỘI DUNG TRANG — mỗi JSP con sẽ điền vào đây --%>
            <div class="page-content">
                <%-- INCLUDE NỘI DUNG Ở ĐÂY --%>
